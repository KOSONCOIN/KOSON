...
contract Koson is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 9210000000000 * _DECIMALFACTOR;
    ...
    uint256 private _MAX_TX_SIZE = 9210000000000 * _DECIMALFACTOR;
